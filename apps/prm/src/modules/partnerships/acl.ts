const features = [
  { id: 'partnerships.agencies.manage', title: 'Manage agencies (PM only)', module: 'partnerships' },
  { id: 'partnerships.wic.manage', title: 'Manage WIC imports (PM only)', module: 'partnerships' },
